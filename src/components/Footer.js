      ...
      <div className="bg-body-tertiary bg-dark">
        ...
        <div className="row">
          ...
          <div className="col-lg-6 text-white fw-lighter text-center">
            ...
            <p>LinkedIn Profile: <a className="text-white" href="https://github.com/MlamliLolwane" target="_blank" rel="noreferrer" >Mlamli Lolwane LinkedIn</a></p>
            <p>iLetters Source Code: <a className="text-white" href="https://github.com/MlamliLolwane" target="_blank" rel="noreferrer" >Mlamli Lolwane iLetters Project</a></p>
          </div>
        </div>
      </div>
    </div>
